        ...
        <div id="demo" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?= base_url('picture/pict01.jpg') ?>" class="d-block" style="width:1500px;height:600px" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?= base_url('picture/pict02.jpg') ?>" class="d-block" style="width:1500px;height:600px" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?= base_url('picture/pict03.jpg') ?>" class="d-block" style="width:1500px;height:600px" alt="...">
                </div>
            </div>
